...
{
    public override Task Handle(object notification, IServiceProvider services,
        CancellationToken cancellation = default)
    {
        return Handle((TDomainEvent) notification, services, cancellation);
    }

    public override Task Handle(TDomainEvent notification, IServiceProvider services,
